...
/*********************************************************/
/* SUSFS INTERNAL KERNEL FUNCTIONS & MACROS FOR LINKER */
/*********************************************************/
/* menyesuaikan supercall */
#ifdef CONFIG_KSU_SUSFS

extern int susfs_try_umount(void *id); 
extern void susfs_reorder_mnt_id(void);
extern void susfs_set_i_state_on_external_dir(void *arg);
extern void susfs_add_try_umount(void *arg);
...
#define SUSFS_IS_INODE_OPEN_REDIRECT_WITHOUT_UID_CHECK(inode) \
	(inode && (inode->i_susfs_flags & SUSFS_BI_INODE_OPEN_REDIRECT))
#endif
#endif
/* linex Project */
